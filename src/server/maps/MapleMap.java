...
public final class MapleMap{
    ...
    public static int 持有道具不饥饿 = (int)Integer.valueOf(ServerProperties.getProperty("HuiMs.持有道具不饥饿"));
    public static int 吸怪盒子 = (int)Integer.valueOf(ServerProperties.getProperty("HuiMs.吸怪特权"));
    private short top;
    ...
    private void dropFromMonster(final MapleCharacter chr, final MapleMonster mob) {
        ...
        //判断该地图道具数量
        if (mapObjects.get(MapleMapObjectType.ITEM).size() >= HuiMS.ConfigValuesMap.get("地图物品上限")) {
            removeDrops();
    ...
    public final void 地图杀怪(final MapleMonster monster, final MapleCharacter chr) {
        ...
        if (mobid == MapleParty.通缉BOSS && this.mapid == MapleParty.通缉地图) {
            ...
            if ((int)Integer.valueOf(HuiMS.ConfigValuesMap.get((Object)"屠令广播开关")) <= 0) {
    ...
    public final void spawnMesoDrop(final int meso, final Point position, final MapleMapObject dropper, final MapleCharacter owner, final boolean playerDrop, final byte droptype) {
        ...
        if (!everlast) {
            int 物品掉落持续时间 = HuiMS.ConfigValuesMap.get("物品掉落持续时间");
    ...
    public final void spawnItemDrop(final MapleMapObject dropper, final MapleCharacter owner, final IItem item, final Point pos, final boolean ffaDrop, final boolean playerDrop) {
        ...
        if (!this.everlast) {
            if (getId() >= 209000001 && getId() <= 209000015) {
                ...
                int 物品掉落持续时间 = HuiMS.ConfigValuesMap.get("物品掉落持续时间");
                drop.registerExpire(物品掉落持续时间 * 1000);
            }
            this.activateItemReactors(drop, owner.getClient());
        }
    }
    ...
    public final void addPlayer(final MapleCharacter chr) {
        ...
        if ((int)Integer.valueOf(HuiMS.ConfigValuesMap.get((Object)"地图名称开关")) == 0) {
    ...
    public void respawn(final boolean force) {
        ...
        if (force) {
            ...
            final int defaultNum = (GameConstants.isForceRespawn(this.mapid) ? this.monsterSpawn.size() * MapConstants.isMonsterSpawn(this) : this.maxRegularSpawn) - this.spawnedMonstersOnMap.get();
    ...
    static {
        ...
        MapleMap.特殊宠物吸取开关 = Boolean.parseBoolean(ServerProperties.getProperty("HuiMs.特殊宠物吸取开关"));
        MapleMap.特殊宠物吸物开关 = Boolean.parseBoolean(ServerProperties.getProperty("HuiMs.特殊宠物吸物开关"));
        MapleMap.特殊宠物吸金开关 = Boolean.parseBoolean(ServerProperties.getProperty("HuiMs.特殊宠物吸金开关"));
        MapleMap.特殊宠物吸物无法使用地图开关 = Boolean.parseBoolean(ServerProperties.getProperty("HuiMs.特殊宠物吸物无法使用地图开关"));
        MapleMap.特殊宠物吸物无法使用地图 = ServerProperties.getProperty("HuiMs.特殊宠物吸物无法使用地图").split(",");
        MapleMap.持有物道具 = (int)Integer.valueOf(ServerProperties.getProperty("HuiMs.持有物道具"));
    }
