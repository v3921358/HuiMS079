...
public class MapleStatEffect implements Serializable
{
            ...
            switch (this.sourceid) {
                ...
                case 2300000: {
                    ...
                    if (absorbMp > 0 && mob.canAbsorbMP()) {
                        ...
                        applyto.getStat().setMp((int)(short)(applyto.getStat().getMp() + absorbMp),applyto);
            ...
            default: {
                ...
                if (this.isMonsterRiding()) {
                    ...
                    if (mountid != 0 && mountid2 != 0) {
                        final List<Pair<MapleBuffStat, Integer>> stat3 = Collections.singletonList(new Pair(MapleBuffStat.MONSTER_RIDING, Integer.valueOf(0)));
                        applyto.cancelEffectFromBuffStat(MapleBuffStat.POWERGUARD);
                        applyto.cancelEffectFromBuffStat(MapleBuffStat.MANA_REFLECTION);
                        applyto.getClient().getSession().writeAndFlush(MaplePacketCreator.giveMount(mountid2, this.sourceid, stat3));
    ...
    public final int getMorph(final MapleCharacter chr) {
        return getMorph() + chr.getGender() * 100;
    }
