...
public class SpawnPoint extends Spawns{
    ...
    public final boolean shouldSpawn() {
        return this.mobTime >= 0 && ((this.mobTime == 0 && !this.immobile) || this.spawnedMonsters.get() <= 0) && this.spawnedMonsters.get() <= MapleParty.怪物倍率 && this.spawnedMonsters.get() <= MapleParty.monsterSpawn && this.nextPossibleSpawn <= System.currentTimeMillis();
    }
    @Override
