...
public class CashItemInfo{
    ...
    public static class CashModInfo{
        ...
        public CashModInfo(final int sn, final int discount, final int mark, final boolean show, final int itemid, final int priority, final boolean packagez, final int period, final int gender, final int count, final int meso, final int unk_1, final int unk_2, final int unk_3, final int extra_flags, final int mod) {
            this.sn = sn;
            this.itemid = itemid;
