...
public class GodCommand{
    ...
    public static class Maxstats extends CommandExecute
    {
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            final MapleCharacter player = c.getPlayer();
            player.getStat().setHp(30000,player);
            player.getStat().setMp(30000,player);
            player.getStat().setMaxHp((short)30000,player);
            player.getStat().setMaxMp((short)30000,player);
            player.getStat().setStr((short)32767,player);
            player.getStat().setDex((short)32767,player);
            player.getStat().setInt((short)32767,player);
            player.getStat().setLuk((short)32767,player);
