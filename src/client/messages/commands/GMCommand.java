...
public class GMCommand{
    ...
    public static class 修改人气商品 extends CommandExecute{
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            ...
            if (input < 1 || input > 5) {
                c.getPlayer().dropMessage("数字只能输入1~5之间");
                return true;
            }
    ...
    public static class 保存所有角色 extends CommandExecute{
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
            int p = 0;
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!保存所有角色 - 储存所有角色资料").toString();
        }
    }
    
    public static class 血魔归一 extends CommandExecute{
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!血魔归一 - HP和MP为1").toString();
        }
    }
    ...
    public static class 我的位置 extends CommandExecute{
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!我的位置 - 我的位置").toString();
        }
    }
    ...
    public static class 公告 extends CommandExecute{
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!公告 <n|p|l|nv|v|b> <m|c|w> <message> - 公告").toString();
        }
    }
    ...
    public static class 黄色公告 extends CommandExecute{
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!黄色公告 <m|c|w> <message> - 黄色公告").toString();
        }
    }
    ...
    public static class 打开npc extends CommandExecute{
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!打开npc <NPC代码> - 开启NPC").toString();
        }
    }
    ...
    public static class 取消所有buff extends CommandExecute{
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!取消所有buff - 取消所有BUFF").toString();
        }
    }
    ...
    public static class warp extends CommandExecute{
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            if (splitted.length < 2) {
                ...
                c.getPlayer().dropMessage(6, "使用 !warp <目的地>. 目的地地图如下:");
                final StringBuilder sb = new StringBuilder();
    ...
    public static class 清理地面 extends CommandExecute{
        @Override
        public boolean execute(final MapleClient c, final String[] splitted) {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!清理地面 - 移除地上的物品").toString();
        }
    }
    ...
    public static class ExpRate extends CommandExecute{
        ...
        public boolean execute(final MapleClient c, final String[] splitted) {
            if (splitted.length > 1) {
                final double rate = Double.parseDouble(splitted[1]);
