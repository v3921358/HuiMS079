...
public class PlayerStats implements Serializable{
    ...
    public static final short maxStr = 32767;
    ...
    public final boolean setHp(final int newhp, final boolean silent, MapleCharacter chra) {
    ...
    public final void setMaxHp(final short hp, final MapleCharacter chra) {
        this.maxhp = hp;
        this.recalcLocalStats(chra);
    }
    
    public final void setMaxMp(final short mp, final MapleCharacter chra) {
        this.maxmp = mp;
        this.recalcLocalStats(chra);
    }
    ...
    public void recalcLocalStats(boolean first_login, MapleCharacter chra) {
        ...
        this.dropMod = 1;
        this.dropm = 1.0;
        this.expMod = WorldConstants.EXP_RATE;
        this.expm = 1.0;
        this.TZ1 = 0;
        this.TZ2 = 0;
        this.TZ3 = 0;
        ...
        for (final IItem item : chra.getInventory(MapleInventoryType.EQUIPPED)) {
            ...
            jump += equip.getJump();
            if(HuiMS.ConfigValuesMap.get("套装系统开关") <=0){//开启
        ...
        for (final IItem item2 : chra.getInventory(MapleInventoryType.CASH)) {
            if (item2.getItemId() / 100000 == 52) {
                if (expMod < 3 && item2.getItemId() == 5211060) { //三倍经验卡(2小时)
                    expMod = 3.0;//overwrite
                } else if (expMod < 2 && (item2.getItemId() == 5210000 //双倍经验值卡一天权
                        || item2.getItemId() == 5210001 //双倍经验值卡七天权
                        || item2.getItemId() == 5210002 //双倍经验值卡一天权(白)
                        || item2.getItemId() == 5210003 //双倍经验值卡七天权(白)
                        || item2.getItemId() == 5210004 //双倍经验值卡一天(晚)
                        || item2.getItemId() == 5210005 //双倍经验值卡七天(晚)
                        || item2.getItemId() == 5210006 //双倍经验值一七天(特价)
                        || item2.getItemId() == 5211047 //双倍经验值卡三小时权
                        )) {
                    expMod = 2.0;
                } else if (expMod < 1.5 && (item2.getItemId() == 5211063 //经验值1.5倍 7天权 (下午券)
                        || item2.getItemId() == 5211064 //经验值1.5倍 7天权 (夜间券)
                        || item2.getItemId() == 5211065 //经验值1.5倍 28天权 (下午券)
                        || item2.getItemId() == 5211066 //经验值1.5倍 28天权 (夜间券)
                        || item2.getItemId() == 5211069 //经验值1.5倍 1天权 (夜间券)
                        || item2.getItemId() == 5211070 //经验值1.5倍 1天权 (下午券)
                        )) {
                    expMod = 1.5;
                } else if (expMod < 1.2 && (item2.getItemId() == 5211071
                        || item2.getItemId() == 5211072
                        || item2.getItemId() == 5211073
                        || item2.getItemId() == 5211074
                        || item2.getItemId() == 5211075
                        || item2.getItemId() == 5211076
                        || item2.getItemId() == 5211067)) {
                    expMod = 1.2;
                }
            }
            if (this.dropMod == 1) {
        ...
        if(HuiMS.ConfigValuesMap.get("套装叠加开关") > 0){
    ...
    public final void handleProfessionTool(final MapleCharacter chra) {
        if (chra.getProfessionLevel(92000000) > 0 || chra.getProfessionLevel(92010000) > 0) {
            for (final Equip equip :(List<Equip>)(List)chra.getInventory(MapleInventoryType.EQUIP).newList()) {
