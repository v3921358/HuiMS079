...
public class ChannelServer implements Serializable
{
    ...
    private short port = 7571;
    private static final short DEFAULT_PORT = 7571;
    public int channel;
    ...
    private static String 初始ip = ServerProperties.getProperty("HuiMs.CustomIP");
    private ChannelServer(final int channel) {
        this.port = (short)Integer.parseInt(ChannelServer.cf.getConfig("HuiMs.channel.port1"));
    ...
    public final void setup() {
        ...
        try {
            this.eventSM = new EventScriptManager(this, ServerProperties.getProperty("HuiMs.events").split(","));
            this.port =(short) ((ServerProperties.getProperty("HuiMs.channel.port", DEFAULT_PORT) + channel) - 1);
        }
        catch (Exception e) {
    ...
    public final void addPlayer(final MapleCharacter chr) {
        ...
        if ((int)Integer.valueOf(HuiMS.ConfigValuesMap.get((Object)"滚动公告开关")) <= 0) {
    ...
    public final void setExpRate(final double expRate) {
    ...
    public final void reloadEvents() {
        this.eventSM.cancel();
        (this.eventSM = new EventScriptManager(this, ServerProperties.getProperty("HuiMs.events").split(","))).init();
    }
    ...
    static {
        ChannelServer.离线挂机 = Boolean.parseBoolean(ServerProperties.getProperty("HuiMs.离线挂机"));
