...
public class 活动野外通缉 {
    ...
    public static void 随机通缉() {
        if (gui.HuiMS.ConfigValuesMap.get("野外通缉开关") == 0) {
            ...
            MapleMap mapleMap = channelServer.getMapFactory().getMap(MapleParty.通缉地图);
            MapleMonster mobName = MapleLifeFactory.getMonster(MapleParty.通缉BOSS);
