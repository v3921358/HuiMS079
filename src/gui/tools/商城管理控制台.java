...
public class 商城管理控制台 extends javax.swing.JFrame {
    ...
    public static int update上下架(CashItemInfo merchandise) {//修改
        ...
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            ps = con.prepareStatement("update cashshop_modified_items set showup = ? where serial = ?");//itemid
...
//                System.out.println( MapleItemInformationProvider.getInstance().getName(1302000));
    ...
    public void initCharacterPannel() {
        ...
        charTable.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                String a12 = charTable.getValueAt(i, 12).toString();
                商品编码.setText(a1);
                商品代码.setText(a2);
                商品数量.setText(a3);
                商品价格.setText(a4);
    ...
    public void 删除SN库存() {
        ...
        ResultSet rs2 = null;
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            ps2 = con.prepareStatement("SELECT * FROM character7 WHERE Name = ?");
    ...
    public void 删除SN库存2() {
        ...
        ResultSet rs2 = null;
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            ps2 = con.prepareStatement("SELECT * FROM character7 WHERE Name = ?  &&  channel = 2");
            ps2.setInt(1, Integer.parseInt(this.商品编码.getText()));
            rs2 = ps2.executeQuery();
            if (rs2.next()) {
                String sqlstr = " delete from character7 where Name =" + Integer.parseInt(this.商品编码.getText()) + ";";
    ...
    public void 删除SN库存3() {
        ...
        ResultSet rs2 = null;
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            ps2 = con.prepareStatement("SELECT * FROM character7 WHERE Name = ?  &&  channel = 3");
            ps2.setInt(1, Integer.parseInt(this.商品编码.getText()));
            rs2 = ps2.executeQuery();
            if (rs2.next()) {
                String sqlstr = " delete from character7 where Name =" + Integer.parseInt(this.商品编码.getText()) + ";";
    ...
    public void 删除SN库存4() {
        ...
        ResultSet rs2 = null;
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            ps2 = con.prepareStatement("SELECT * FROM character7 WHERE Name = ?  &&  channel = 4");
            ps2.setInt(1, Integer.parseInt(this.商品编码.getText()));
            rs2 = ps2.executeQuery();
            if (rs2.next()) {
                String sqlstr = " delete from character7 where Name =" + Integer.parseInt(this.商品编码.getText()) + ";";
    ...
    public static void Gain商城物品(int Piot, int Piot1) {
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            ...
            if (ret == -1) {
                ...
                PreparedStatement ps = null;
                try {
                    ps = con.prepareStatement("INSERT INTO cashshop_modified_items (serial,meso) VALUES (?, ?)");
                    int serial = 0;
                    ps.setInt(1, serial);
                    ps.setInt(2, ret);
                    ps.execute();
    ...
    private void initComponents() {
        ...
        getContentPane().add(显示类型, new org.netbeans.lib.awtextra.AbsoluteConstraints(526, 580, 120, 25));
        ...
        getContentPane().add(商品出售状态, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 580, 70, 25));
        ...
        jPanel18Layout.setVerticalGroup(
            jPanel18Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(读取热销产品, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(主题馆, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(活动, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel19.add(帽子, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 65, 30));
        ...
        jPanel19.add(脸饰, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 0, 65, 30));
        ...
        jPanel19.add(眼饰, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 0, 65, 30));
        ...
        jPanel19.add(长袍, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 65, 30));
        ...
        jPanel19.add(上衣, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 0, 65, 30));
        ...
        jPanel19.add(裙裤, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 0, 65, 30));
        ...
        jPanel19.add(鞋子, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 65, 30));
        ...
        jPanel19.add(手套, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 0, 65, 30));
        ...
        jPanel19.add(武器, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 0, 65, 30));
        ...
        jPanel19.add(戒指, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 0, 65, 30));
        ...
        jPanel19.add(飞镖, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 0, 65, 30));
        ...
        jPanel19.add(披风, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 0, 65, 30));
        ...
        jPanel19.add(骑宠, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 0, 65, 30));
        ...
        jPanel20Layout.setVerticalGroup(
            jPanel20Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(喜庆物品, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(通讯物品, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(卷轴, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        ...
        jPanel22Layout.setVerticalGroup(
            jPanel22Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(宠物, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(宠物服饰, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(其他, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        );

        jTabbedPane3.addTab("宠物", jPanel22);

        getContentPane().add(jTabbedPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 950, 80));
        ...
        商品数量.setFont(new java.awt.Font("微软雅黑", 0, 12)); // NOI18N
        jPanel24.add(商品数量, new org.netbeans.lib.awtextra.AbsoluteConstraints(235, 55, 65, 25));

        商品编码.setFont(new java.awt.Font("微软雅黑", 0, 12)); // NOI18N
        商品编码.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                商品编码ActionPerformed(evt);
            }
        });
        jPanel24.add(商品编码, new org.netbeans.lib.awtextra.AbsoluteConstraints(84, 25, 65, 25));

        商品代码.setFont(new java.awt.Font("微软雅黑", 0, 12)); // NOI18N
        jPanel24.add(商品代码, new org.netbeans.lib.awtextra.AbsoluteConstraints(84, 55, 65, 25));
        ...
        商品价格.setFont(new java.awt.Font("微软雅黑", 0, 12)); // NOI18N
        jPanel24.add(商品价格, new org.netbeans.lib.awtextra.AbsoluteConstraints(234, 25, 65, 25));

        商品时间.setFont(new java.awt.Font("微软雅黑", 0, 12)); // NOI18N
        商品时间.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                商品时间ActionPerformed(evt);
            }
        });
        jPanel24.add(商品时间, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 55, 65, 25));
        ...
        商品库存.setFont(new java.awt.Font("微软雅黑", 0, 12)); // NOI18N
        jPanel24.add(商品库存, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 25, 65, 25));

        商品折扣.setFont(new java.awt.Font("微软雅黑", 0, 12)); // NOI18N
        jPanel24.add(商品折扣, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 25, 65, 25));
        ...
        每日限购.setFont(new java.awt.Font("微软雅黑", 0, 12)); // NOI18N
        jPanel24.add(每日限购, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 55, 65, 25));
        ...
        货币类型.setFont(new java.awt.Font("微软雅黑", 0, 12)); // NOI18N
        jPanel24.add(货币类型, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 25, 65, 25));

        点券购买.setFont(new java.awt.Font("微软雅黑", 0, 12)); // NOI18N
        点券购买.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                点券购买ActionPerformed(evt);
            }
        });
        jPanel24.add(点券购买, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 55, 65, 25));

        jLabelUseNX.setFont(new java.awt.Font("宋体", 0, 15)); // NOI18N
        jLabelUseNX.setText("点券购买；");
        jPanel24.add(jLabelUseNX, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 55, -1, 20));
        ...
        charTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "商品编码", "物品代码", "道具名称", "数量", "价格", "天/限时", "出售状态", "上/下架", "已售出", "库存", "反馈/%", "每日限购", "货币类型"
            }
        ) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel24, javax.swing.GroupLayout.PREFERRED_SIZE, 740, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(14, 14, 14)
                        .addComponent(jPanel24, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
        ...
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            ps1 = con.prepareStatement("SELECT * FROM cashshop_modified_items WHERE serial = ?");
            ps1.setInt(1, 商城SN编码);
    ...
    private void 添加ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_添加ActionPerformed
        ...
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            ...
            if (!rs.next()) {
                try (PreparedStatement ps = con.prepareStatement("INSERT INTO cashshop_modified_items (serial, showup,itemid,priority,period,gender,count,meso,discount_price,mark, unk_1, unk_2, unk_3,use_nx, period_hour, day_limit) VALUES (?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")) {
    ...
    private void 修改ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_修改ActionPerformed
        ...
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            ...
            //ps = con.prepareStatement("UPDATE cashshop_modified_items SET showup = ?, itemid = ?, priority = ?, period = ?, gender = ?, count = ?, meso = ?, discount_price = ?, mark = ?, unk_1 = ?, unk_2 = ?, unk_3 = ? WHERE serial = ?");
            ps = con.prepareStatement("UPDATE cashshop_modified_items SET  itemid = ?, period = ?, count = ?, discount_price = ?, mark = ?, use_nx = ?, period_hour = ?, day_limit = ? WHERE serial = ?");
