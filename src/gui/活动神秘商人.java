...
public class 活动神秘商人 {
     ...
     */
    //神秘商人代码
    public static int 神秘商人 = 9900001;
    //商人出现后存在的时间/分
    ...
    public static void 随机商人出现条件() {
        //随机频道
        int pind = (int) Math.ceil(Math.random() * Integer.parseInt(ServerProperties.getProperty("HuiMs.channel.count")));
        //如果随机的频道为0，则加1
        if (pind == 0) {
            pind += 1;
        }
        ...
        //召唤的频道
        ChannelServer channelServer = ChannelServer.getInstance(MapleParty.神秘商人频道);
        //召唤的地图
        MapleMap mapleMap = channelServer.getMapFactory().getMap(MapleParty.神秘商人地图);
        //通知信息
        String 信息 = "[神秘商人] : 一个神秘的商人 " + MapleParty.神秘商人时间 + " 时将出现在 " + MapleParty.神秘商人频道 + " 频道的某个地方。";
    ...
    public static void 召唤神秘商人() {
        ...
        MapleMap mapleMap = channelServer.getMapFactory().getMap(MapleParty.神秘商人地图);
        //召唤商人
        mapleMap.spawnNpc(神秘商人, new Point(MapleParty.神秘商人坐标X, MapleParty.神秘商人坐标Y));
        //延时执行
        String 信息 = "[神秘商人] : 一个神秘的商人出现在 " + MapleParty.神秘商人频道 + " 频道" + mapleMap.getMapName() + "。";
        World.Broadcast.broadcastMessage(MaplePacketCreator.serverNotice(6, 信息));
        System.err.println("[服务端]" + CurrentReadable_Time() + " : " + 信息);
        MapleParty.神秘商人 += 1;
        new Thread() {
