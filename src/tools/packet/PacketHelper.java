...
public class PacketHelper{
    ...
    public static final void addCharLook(final MaplePacketLittleEndianWriter mplew, final MapleCharacter chr, final boolean mega) {
        ...
        mplew.writeInt(chr.getHair());
        final Map<Byte, Integer> myEquip = (Map<Byte, Integer>)new LinkedHashMap();
        final Map<Byte, Integer> maskedEquip = (Map<Byte, Integer>)new LinkedHashMap();
    ...
    public static void addEquipStats(MaplePacketLittleEndianWriter mplew, Equip equip) {
        ...
        mplew.writeInt((int) (equip.getExpPercentage() * 300000));
