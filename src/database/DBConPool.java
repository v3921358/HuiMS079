...
public class DBConPool
{
    ...
    public static void InitDB() {
        DBConPool.dbName = ServerProperties.getProperty("HuiMs.db.name", DBConPool.dbName);
        DBConPool.dbIp = ServerProperties.getProperty("HuiMs.db.ip", DBConPool.dbIp);
        DBConPool.dbport = ServerProperties.getProperty("HuiMs.db.port", DBConPool.dbport);
        DBConPool.dbUser = ServerProperties.getProperty("HuiMs.db.user", DBConPool.dbUser);
        DBConPool.dbPass = ServerProperties.getProperty("HuiMs.db.password", DBConPool.dbPass);
    }
    ...
    private void InitDBConPool() {
        ...
        DBConPool.dbName = DBConPool.dbProps.getProperty("HuiMs.db.name");
        DBConPool.dbHost = DBConPool.dbProps.getProperty("HuiMs.db.host");
        DBConPool.dbPort = DBConPool.dbProps.getProperty("HuiMs.db.port");
        DBConPool.dbUser = DBConPool.dbProps.getProperty("HuiMs.db.user");
        DBConPool.dbPass = DBConPool.dbProps.getProperty("HuiMs.db.password");
