...
public class DatabaseConnection
{
    ...
    private static Connection connectToDB() {
        if (!DatabaseConnection.propsInited) {
            ...
            DatabaseConnection.dbName = DatabaseConnection.dbProps.getProperty("HuiMs.db.name");
            DatabaseConnection.dbHost = DatabaseConnection.dbProps.getProperty("HuiMs.db.host");
            DatabaseConnection.dbPort = DatabaseConnection.dbProps.getProperty("HuiMs.db.port");
            ...
            DatabaseConnection.dbUser = DatabaseConnection.dbProps.getProperty("HuiMs.db.user");
            DatabaseConnection.dbPass = DatabaseConnection.dbProps.getProperty("HuiMs.db.password");
            try {
