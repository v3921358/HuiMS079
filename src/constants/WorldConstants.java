...
public class WorldConstants
{
    ...
    public static double EXP_RATE;
    public static String EXP_RATE1;
    ...
    public static void loadSetting() {
        WorldConstants.ADMIN_ONLY = ServerProperties.getProperty("HuiMs.admin", WorldConstants.ADMIN_ONLY);
        WorldConstants.FLAG = ServerProperties.getProperty("HuiMs.flag", WorldConstants.FLAG);
        WorldConstants.EXP_RATE1 = ServerProperties.getProperty("HuiMs.expRate");
        WorldConstants.MESO_RATE = ServerProperties.getProperty("HuiMs.mesoRate", WorldConstants.MESO_RATE);
        WorldConstants.DROP_RATE = ServerProperties.getProperty("HuiMs.dropRat", WorldConstants.DROP_RATE);
        WorldConstants.WORLD_TIP = ServerProperties.getProperty("HuiMs.eventMessage", WorldConstants.WORLD_TIP);
        WorldConstants.SCROLL_MESSAGE = ServerProperties.getProperty("HuiMs.serverMessage", WorldConstants.SCROLL_MESSAGE);
        WorldConstants.CHANNEL_COUNT = ServerProperties.getProperty("HuiMs.channel.count", WorldConstants.CHANNEL_COUNT);
        WorldConstants.USER_LIMIT = (int)Integer.valueOf(HuiMS.ConfigValuesMap.get((Object)"服务端最大人数"));
        WorldConstants.MAX_CHAR_VIEW = ServerProperties.getProperty("HuiMs.maxCharView", WorldConstants.MAX_CHAR_VIEW);
        WorldConstants.GMITEMS = ServerProperties.getProperty("HuiMs.gmitems", WorldConstants.GMITEMS);
        WorldConstants.CS_ENABLE = ServerProperties.getProperty("HuiMs.cashshop.enable", WorldConstants.CS_ENABLE);
        WorldConstants.EXP_RATE = Double.parseDouble(WorldConstants.EXP_RATE1);
    }
