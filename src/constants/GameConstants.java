...
public class GameConstants{
    ...
    public static int getExpNeededForLevelS(int level) {
        return GameConstants.ExpTable[level];
    }
    ...
    static {
        GameConstants.冒险岛名字 = ServerProperties.getProperty("HuiMs.serverName");
        ...
        lBalloon = Arrays.asList(new Balloon("欢迎來到" + LoginServer.getServerName(), 236, 122), new Balloon("禁止开外挂", 0, 276), new Balloon("开服联系唯一QQ：492214831", 196, 263));
    }
}
